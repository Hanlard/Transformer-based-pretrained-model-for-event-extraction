...
class EERunner(object):
    def __init__(self):
        ...
        parser.add_argument("--test", help="validation set",default='C:\Hanlard\\NLP\模型\事件抽取\EMNLP2018-JMEE-master\\ace-05-splits\\test.json')
        parser.add_argument("--train", help="training set",default='C:\Hanlard\\NLP\模型\事件抽取\EMNLP2018-JMEE-master\\ace-05-splits\\train_del.json')
        parser.add_argument("--dev", help="development set",default='C:\Hanlard\\NLP\模型\事件抽取\EMNLP2018-JMEE-master\\ace-05-splits\\dev.json')
        ...
        parser.add_argument("--earlystop", default=99999, type=int)
        parser.add_argument("--restart", default=99999, type=int)
