...
import pytorch_transformers as pys
...
if os.name == "nt":
    ...
    tokenizer = pys.tokenization_bert.BertTokenizer.from_pretrained("bert-base-cased")
    # print("BertTokenizer.from_pretrained('bert-base-cased')")
else:
    # tokenizer = BertTokenizer.from_pretrained('bert-large-cased', do_lower_case=False, never_split=(PAD, CLS, SEP, UNK))
    # print("BertTokenizer.from_pretrained('bert-large-cased')")
    tokenizer = pys.tokenization_bert.BertTokenizer.from_pretrained("bert-large-cased")
